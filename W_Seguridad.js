...
* @version 2.4.0
* @reparacion [A1] Eliminado bloque de código muerto post-return en w_verificarIdentidadZeroTrust.
* @reparacion Funciones w_upsertUsuario y w_upsertRol conservadas para compatibilidad legacy.
*             El frontend principal usa w_EjecutarTransaccionSegura (Motor Universal v6.0.0).
*/
...
// ==========================================
/**
* @description Motor Zero Trust v2.4.0 — Código muerto eliminado.
* @param {string} ip - IP del cliente capturada en el frontend
* @returns {string} JSON con resultado de autenticación
*/
function w_verificarIdentidadZeroTrust(ip) {
  ...
  try {
    ...
    // 4. REGISTRO FORENSE DE ÉXITO (Único — reparación A1)
    w_registrarLogForense('AUTH_SUCCESS', 'SEGURIDAD', uuid, 'Ingreso exitoso. Rol: ' + nombreRol, ip);

    // 5. RESPUESTA EXITOSA (Único return — reparación A1)
...
/**
 * ============================================================================
 * CONTROLADORES DE ESCRITURA DE SEGURIDAD (LEGACY)
 * ============================================================================
 * Nota v2.4.0: Estas funciones se conservan para compatibilidad con flujos
 * existentes. El frontend principal ahora usa w_EjecutarTransaccionSegura
 * (Motor Universal v6.0.0) para usuarios y roles vía S_Seguridad.html.
 */
...
// ==========================================================
// MOTOR DE SEGURIDAD ZERO-LATENCY (CACHE SERVICE)
// ==========================================================
